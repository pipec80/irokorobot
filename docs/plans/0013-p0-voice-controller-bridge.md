...
> **Status:** Implemented — awaiting the mandatory human R1 manual checkpoint
> and PR publication.
...
- Implement R1 only from [Plan 0012](0012-p0-runtime-acceptance-design.md).
...
- `docs/plans/0012-p0-runtime-acceptance-design.md`
...
- Modify: `docs/plans/0013-p0-voice-controller-bridge.md`
