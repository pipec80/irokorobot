...
| Lane | Plans | Meaning |
|---|---|---|
| **NOW** | none | Plan 0041 closed 2026-09-03. Plan 0042 is next in the 0031 chain but promotion needs Pipec's explicit authorization. |
...
| **QUEUED** | [0042 — server baseline closure](open/0042-server-baseline-closure.md) | Next child in the order locked by 0031: full gates, runtime evidence, ADR review, and closure of the whole 0031 capsule. Promotion needs Pipec's explicit authorization. |
...
| 22 | [0041 — streaming terminal contract](completed/0041-streaming-terminal-contract.md) | Merged 2026-09-03 (PR #111), real live acceptance recorded (TTS-failure branch deferred by Pipec, covered in depth by automated tests) | Closed. Plan 0042 is unblocked and awaits explicit promotion |
