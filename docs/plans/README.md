...
| Lane | Plans | Meaning |
|---|---|---|
| **NOW** | none | Plan 0038 closed 2026-09-03. Plan 0039 is next in the 0031 chain but promotion needs Pipec's explicit authorization. |
...
| **QUEUED** | [0039 — application lifecycle and HTTP resources](open/0039-application-lifecycle-and-http-resources.md) | Next child in the order locked by 0031: explicit FastAPI composition/cleanup and shared outbound HTTP resources. Promotion needs Pipec's explicit authorization. Children 0040–0042 remain transitively queued. |
...
| 19 | [0038 — Uvicorn runtime baseline](completed/0038-uvicorn-runtime-baseline.md) | Merged 2026-09-03 (PR #105); no live acceptance turn applies, config/tests only | Closed. Plan 0039 is unblocked and awaits explicit promotion |
