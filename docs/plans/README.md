...
| Lane | Plans | Meaning |
|---|---|---|
| **NOW** | [0043 — dependency refresh](open/0043-dependency-refresh.md) | Transversal lock refresh to latest stable, authorized 2026-09-02. Runs before the 0031 capsule because two queued children change design with it: Starlette 1.6.0 ships `RequestBodyLimitMiddleware`, so 0034 drops its hand-written raw body limit, and 0038 must record the real Uvicorn version. Code, gates and evidence are complete — 929 tests, typecheck, audit and all 17 hooks green; only Pipec's real voice-turn acceptance remains. |
...
| **QUEUED** | [0032 — server privacy and request observability](open/0032-server-privacy-and-request-observability.md) | First executable child of the audited server-production capsule. Promotion needs Plan 0043 closed plus Pipec's explicit authorization — revalidate 0032's named log sites first. Children 0033–0042 remain transitively queued in the order locked by 0031. |
...
| 11 | [0043 — dependency refresh](open/0043-dependency-refresh.md) | Executed 2026-09-02, all gates green | Awaiting Pipec's real voice-turn acceptance; closing it unblocks Plan 0032 |
