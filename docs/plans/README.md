...
| Lane | Plans | Meaning |
|---|---|---|
| **NOW** | none | Plan 0032 closed 2026-09-02 with two real voice-turn acceptances. Plan 0033 is ready but promotion needs Pipec's explicit authorization. |
...
| **QUEUED** | [0033 — owner unlock HTTP hardening](open/0033-owner-unlock-http-hardening.md) | Next child in the order locked by 0031: deterministic PIN validation (422 vs 401 vs 403 vs 429) and a race-safe limiter. Promotion needs Pipec's explicit authorization. Children 0034–0042 remain transitively queued. |
