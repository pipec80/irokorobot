...
| Lane | Plans | Meaning |
|---|---|---|
| **NOW** | none | Plan 0034 closed 2026-09-02 with real HTTP-path acceptance against the live server. Plan 0035 is ready but promotion needs Pipec's explicit authorization. |
...
| **QUEUED** | [0035 — SQLite transaction owner](open/0035-sqlite-transaction-owner.md) | Next child in the order locked by 0031: one safe runtime transaction primitive. Promotion needs Pipec's explicit authorization. Children 0036–0042 remain transitively queued. |
...
| 15 | [0034 — upload and multipart security](completed/0034-upload-and-multipart-security.md) | Merged 2026-09-02 (PR #98), real HTTP-path acceptance recorded | Closed. Plan 0035 is unblocked and awaits explicit promotion |
