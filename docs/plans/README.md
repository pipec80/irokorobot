...
| Lane | Plans | Meaning |
|---|---|---|
| **NOW** | none | Plan 0036 closed 2026-09-02. Plan 0037 is next in the 0031 chain but promotion needs Pipec's explicit authorization. |
...
| **QUEUED** | [0037 — deterministic CI baseline](open/0037-deterministic-ci-baseline.md) | Next child in the order locked by 0031: a deterministic API/local integration gate at >=80% coverage. Promotion needs Pipec's explicit authorization. Children 0038–0042 remain transitively queued. |
...
| 17 | [0036 — SQLite write migration and outbox removal](completed/0036-sqlite-write-migration-and-outbox-removal.md) | Merged 2026-09-02 (PR #101), real live acceptance recorded | Closed. Plan 0037 is unblocked and awaits explicit promotion |
