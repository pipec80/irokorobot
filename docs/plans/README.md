...
| Lane | Plans | Meaning |
|---|---|---|
| **NOW** | none | Plan 0039 closed 2026-09-03. Plan 0040 is next in the 0031 chain but promotion needs Pipec's explicit authorization. |
...
| **QUEUED** | [0040 — FastAPI contract and OpenAPI baseline](open/0040-fastapi-contract-and-openapi-baseline.md) | Next child in the order locked by 0031: typed dependencies, OpenAPI, health/readiness. Promotion needs Pipec's explicit authorization. Children 0041–0042 remain transitively queued. |
...
| 20 | [0039 — application lifecycle and HTTP resources](completed/0039-application-lifecycle-and-http-resources.md) | Merged 2026-09-03 (PR #107), real live acceptance recorded | Closed. Plan 0040 is unblocked and awaits explicit promotion |
