...
| Lane | Plans | Meaning |
|---|---|---|
| **NOW** | none | Plan 0033 closed 2026-09-02 with real HTTP acceptance against the live server. Plan 0034 is ready but promotion needs Pipec's explicit authorization. |
...
| **QUEUED** | [0034 — upload and multipart security](open/0034-upload-and-multipart-security.md) | Next child in the order locked by 0031: raw and per-file upload limits via Starlette 1.6.0's native `RequestBodyLimitMiddleware`. Promotion needs Pipec's explicit authorization. Children 0035–0042 remain transitively queued. |
...
| 14 | [0033 — owner unlock HTTP hardening](completed/0033-owner-unlock-http-hardening.md) | Merged 2026-09-02 (PR #97), real HTTP acceptance recorded | Closed. Plan 0034 is unblocked and awaits explicit promotion |
