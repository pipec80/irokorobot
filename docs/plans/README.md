...
| Lane | Plans | Meaning |
|---|---|---|
| **NOW** | none | Plan 0037 closed 2026-09-03. Plan 0038 is next in the 0031 chain but promotion needs Pipec's explicit authorization. |
...
| **QUEUED** | [0038 — Uvicorn runtime baseline](open/0038-uvicorn-runtime-baseline.md) | Next child in the order locked by 0031: explicit one-worker runtime defaults. Promotion needs Pipec's explicit authorization. Children 0039–0042 remain transitively queued. |
...
| 18 | [0037 — deterministic CI baseline](completed/0037-deterministic-ci-baseline.md) | Merged 2026-09-03 (PR #103); no live acceptance turn applies, config/tests only | Closed. Plan 0038 is unblocked and awaits explicit promotion |
