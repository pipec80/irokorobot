...
| Lane | Plans | Meaning |
|---|---|---|
| **NOW** | none | Plan 0040 closed 2026-09-03. Plan 0041 is next in the 0031 chain but promotion needs Pipec's explicit authorization. |
...
| **QUEUED** | [0041 — streaming terminal contract](open/0041-streaming-terminal-contract.md) | Next child in the order locked by 0031: a coordinated terminal `error` event for the stream contract. Promotion needs Pipec's explicit authorization. Plan 0042 remains transitively queued. |
...
| 21 | [0040 — FastAPI contract and OpenAPI baseline](completed/0040-fastapi-contract-and-openapi-baseline.md) | Merged 2026-09-03 (PR #109); no live acceptance turn applies, no hot-path body changed | Closed. Plan 0041 is unblocked and awaits explicit promotion |
