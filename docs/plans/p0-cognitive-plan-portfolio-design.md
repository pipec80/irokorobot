...
| [`0003-typed-controller-and-deterministic-tools.md`](0003-typed-controller-and-deterministic-tools.md) | P0.3 | Ready | Introduce a small typed controller seam and deterministic current-date and strict-ISO-age tools only. |
...
quality gates. Plan 0003 is Ready; P0.4 and later plans remain Draft and are
