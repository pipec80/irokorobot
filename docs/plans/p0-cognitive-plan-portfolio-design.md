...
dependency cycle, every phase has one clear outcome, relational schema work is
separated from its decision, and only P0.2 is eligible to become `Ready` first.
