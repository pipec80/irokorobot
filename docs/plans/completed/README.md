...
evidence from completed or superseded slices. A few entries (0014, 0020, 0024)
are umbrella/design documents that never had their own executable code or
gates — they moved here because every slice they governed already closed
elsewhere, not because they were themselves executed. Current work must use the
