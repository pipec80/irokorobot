...
> Use [`current-state.md`](../../architecture/current-state.md) for the current snapshot and
> [`p0-runtime-policy-audit.md`](../../architecture/p0-runtime-policy-audit.md) for the active
...
> record is in [`0002a-local-first-provider-quarantine.md`](../../plans/completed/0002a-local-first-provider-quarantine.md).
